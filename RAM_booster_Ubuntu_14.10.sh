...
#Make sure the OS this is being run on is supported (Ubuntu 14.10)
Check_OS()
{
...
if [[ "$OS_Check" != "14.10" ]]
then
	echo "This script was written to work with Ubuntu 14.10. You are running `cat /etc/issue | egrep -o '[a-Z]+[ ][0-9]+\.[0-9]+\.*[0-9]*'`. This means the script has NOT been tested for your OS. Run this at your own risk."  | fmt -w `tput cols`
	echo
